  ...
  return (
    <div className="bg-white py-16 pb-24">
      <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative bg-gradient-to-r from-[#2143E0] to-blue-600 rounded-[32px] overflow-hidden">
          ...
          <div className="absolute top-[-20%] right-[10%] w-[400px] h-[400px] bg-blue-400/20 rounded-full blur-3xl pointer-events-none" />
